...
## Releases 
- **Current** ([v5.2.3](https://github.com/jest-community/vscode-jest/releases/tag/v5.2.3)): [release note](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-note-v5.x.md#v523)
- **Previous** ([v5.1.0](https://github.com/jest-community/vscode-jest/releases/tag/v5.1.0)): [release note](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-note-v5.x.md#v510)
...
<img src='https://github.com/jest-community/vscode-jest/raw/HEAD/images/status-bar-error.png' width="600" />
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/testExplorer-5.1.1.png" alt="testExplorer.png" width="800"/>
